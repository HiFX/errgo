...
The hifx/errgo provides an easy way to annotate errors without losing the
...
that was the cause.
	...
	err = errgo.Annotatef(err, "context")
	err = errgo.Annotatef(err, "more context")
...
for the situation.
    ...
    if err := FindField(field); err != nil {
	    return errgo.Wrap(err, errgo.NotFoundf(field))
	}
